...
{
    /// <inheritdoc />
    public partial class InitRBACSeedData : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), "USER_CREATE" },
                    { new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), "USER_VIEW" },
                    { new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), "USER_UPDATE" },
                    { new Guid("dddddddd-dddd-dddd-dddd-dddddddddddd"), "USER_DELETE" }
                });
